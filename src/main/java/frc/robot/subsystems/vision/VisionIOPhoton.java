...
public class VisionIOPhoton implements VisionIO {
    ...
    private void processMultitagResult(
    ...
    private void processSingleTagResult(
        PhotonPipelineResult result,
        Set<Short> tagIds,
        List<PoseObservation> poseObservations
    ) {
    ...
    public void updateInputs(VisionIOInputs inputs) {
        ...
        for (PhotonPipelineResult result : camera.getAllUnreadResults()) {
            ...
            if (result.multitagResult.isPresent()) {
                processMultitagResult(result, tagIds, poseObservations);
            } else if (!result.targets.isEmpty()) {
                processSingleTagResult(result, tagIds, poseObservations);
            }
        }
